...
function es(e, n, t) {
  ...
  return { $$typeof: Yt, type: e, key: o, ref: u, props: l, _owner: Ho.current }
}
function gc(e, n) {
  return {
    $$typeof: Yt,
 ...
 */ var _c = Qo,
  ...
  Nc = _c.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
...
function ns(e, n, t) {
  ...
  return { $$typeof: Cc, type: e, key: o, ref: u, props: l, _owner: Nc.current }
}
el.Fragment = xc
el.jsx = ns
el.jsxs = ns
 ...
 */ ;(function (e) {
  ...
  function r(_) {
    ...
    if (z !== N) {
      _[0] = z
      e: for (var H = 0, G = _.length, qt = G >>> 1; H < qt; ) {
        var vn = 2 * (H + 1) - 1,
          gl = _[vn],
          yn = vn + 1,
          bt = _[yn]
        if (0 > l(gl, z))
          yn < G && 0 > l(bt, gl)
            ? ((_[H] = bt), (_[yn] = z), (H = yn))
            : ((_[H] = gl), (_[vn] = z), (H = vn))
        else if (yn < G && 0 > l(bt, z)) (_[H] = bt), (_[yn] = z), (H = yn)
        else break e
      }
    }
    return N
...
function Vc(e, n, t, r, l, o, u, i, s) {
  ;(Et = !1), (Rr = null), $c.apply(Ac, arguments)
}
...
function dt(e, n) {
  e.blockedOn === n &&
    ((e.blockedOn = null),
    fo ||
      ((fo = !0), ye.unstable_scheduleCallback(ye.unstable_NormalPriority, rf)))
}
function jt(e) {
  function n(l) {
    return dt(l, e)
...
var Ir = null
function po(e, n, t, r) {
  if (((Ir = null), (e = qo(r)), (e = kn(e)), e !== null))
...
function Hs(e) {
  if (e.propertyName === 'value' && rl(It)) {
    var n = []
    Vs(n, It, e, qo(e)), Es(Df, n)
  }
}
function If(e, n, t) {
  e === 'focusin'
    ? (ui(), (Ct = n), (It = t), Ct.attachEvent('onpropertychange', Hs))
    : e === 'focusout' && ui()
}
function Ff(e) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              f !== null && ((v = Ot(a, f)), v != null && k.push($t(a, v, d)))),
            I)
          )
            break
          a = a.return
    ...
    if (!(n & 7)) {
      ...
      P &&
        ...
        0 < C.length &&
          ...
          x ? (P.data = x) : ((x = As(t)), x !== null && (P.data = x)))),
        (x = Tf ? Rf(e, t) : Of(e, t)) &&
...
function hn() {
  if (!Il && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), Ps(bo, hn), l)
    } finally {
      ;(O = n), (Il = !1)
    }
  }
...
function Po(e, n, t, r) {
  var l = e.stateNode
  ;(l.props = t), (l.state = e.memoizedState), (l.refs = ia), hu(e)
  var o = n.contextType
  typeof o == 'object' && o !== null
    ? (l.context = Ce(o))
...
function pa(e, n) {
  ...
  if (
    ...
    (r = r.queue),
    Eu(va.bind(null, t, r, e), [e]),
    r.getSnapshot !== n || o || (Z !== null && Z.memoizedState.tag & 1))
  ) {
    if (
      ((t.flags |= 2048),
      Qt(9, ha.bind(null, t, r, l, n), void 0, null),
      J === null)
    )
      throw Error(y(349))
    Nn & 30 || ma(t, n, l)
...
function Pa(e, n, t) {
  return Nn & 21
    ? (Me(t, n) || ((t = Ls()), ($.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
  ...
  od = {
    ...
    useImperativeHandle: function (e, n, t) {
      return (
        ...
        xr(4194308, 4, Ea.bind(null, n, e), t)
      )
    },
    ...
    useSyncExternalStore: function (e, n, t) {
      ...
      return (
        ...
        (r.flags |= 2048),
        Qt(9, ha.bind(null, r, o, t, n), void 0, null),
        t
      )
    },
    useId: function () {
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, n, l))
      : (F && t && su(n), (n.flags |= 1), oe(e, n, r, l), n.child)
  )
}
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, n, l))
      : (F && r && su(n), (n.flags |= 1), oe(e, n, t, l), n.child)
  )
}
function Oi(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    Pr(e, n), sa(n, t, r), Po(n, t, r, l), (r = !0)
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps
    u.props = i
    ...
    var h = t.getDerivedStateFromProps,
      m =
        typeof h == 'function' || typeof u.getSnapshotBeforeUpdate == 'function'
    m ||
...
function hd(e, n) {
  ...
  for (yo = { focusedElem: e, selectionRange: t }, jr = !1, S = n; S !== null; )
...
function Ba(e) {
  ...
  n !== null && ((e.alternate = null), Ba(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[At], delete n[ko], delete n[Jf], delete n[qf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function qr(e, n) {
  ...
  while (1)
  if ((du(), (R = t), (Gr.current = r), Q !== null)) throw Error(y(261))
  return (J = null), (b = 0), X
}
function wd() {
  for (; Q !== null; ) Za(Q)
...
function Ed(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    J === e &&
      (b & t) === t &&
      (X === 4 || (X === 3 && (b & 130023424) === b && 500 > W() - Nu)
        ? _n(e, 0)
        : (Pu |= t)),
    pe(e, n)
}
...
ba = function (e, n, t) {
  ...
  else (ce = !1), F && n.flags & 1048576 && ta(n, Br, n.index)
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            Po(n, r, e, t),
            (n = Lo(null, n, r, !0, o, t)))
          : ((n.tag = 0), F && o && su(n), oe(null, n, l, t), (n = n.child)),
        n
      )
    case 16:
      r = n.elementType
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (eu(n, t | 1), pe(n, W()), !(R & 6) && ((rt = W() + 500), hn()))
      }
      break
    case 13:
      Ln(function () {
...
ks = zu
Ss = Ln
var Rd = { usingClientEntryPoint: !1, Events: [Zt, Un, ol, gs, ws, zu] },
  vt = {
...
const Id = '_wrapper_frgq8_1',
  Fd = { wrapper: Id }
function Ud(e) {
  return K.jsx('h1', { className: Fd.wrapper, children: e.children })
}
const $d = '_wrapper_1i3xv_1',
  Ad = { wrapper: $d }
function yr(e) {
  return K.jsx('div', { className: Ad.wrapper, children: e.children })
}
const Vd = '_container_s8gc7_1',
  Bd = '_avatar_s8gc7_19',
  Hd = '_links_s8gc7_31',
  Kl = { container: Vd, avatar: Bd, links: Hd }
function Wd(e) {
  return K.jsxs('div', {
    className: Kl.container,
    children: [
      K.jsx('img', { id: e.avatar, className: Kl.avatar, src: '', alt: '' }),
      K.jsxs(Ud, { children: [e.name, K.jsx('button', { children: '+' })] }),
      K.jsx(yr, { children: e.bio }),
      K.jsx(yr, { children: e.phone }),
      K.jsx(yr, { children: e.email }),
      K.jsx(yr, {
        children: K.jsxs('div', {
          className: Kl.links,
          children: [
            K.jsx(Ql, { href: e.githubUrl, children: 'GitHub' }),
            K.jsx(Ql, { href: e.linkedinUrl, children: 'LinkedIn' }),
            K.jsx(Ql, { href: e.portfolioUrl, children: 'Portifólio' })
          ]
        })
      })
    ]
...
Yl.createRoot(document.getElementById('root')).render(
  K.jsx(Ec.StrictMode, { children: K.jsx(Qd, {}) })
)
async function Kd() {
  const t = await (
    await fetch('https://api.github.com/users/carloscunha611')
  ).json()
  userImage.src = t.avatar_url
}
Kd()
